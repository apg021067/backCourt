...
//	}
	...
	@ResponseBody
	public Map<String, Object> guestList(String address, String currentPage, String level, String searchWord,
			String searchFlag) {
	...
	public String teamListGo(HttpSession session) {
		String isAdmin = (String) session.getAttribute("isAdmin");
		if (isAdmin == null || isAdmin.isEmpty()) {
			return "redirect:/login.go";
		}
	...
	public String guestListGo(HttpSession session) {
		String isAdmin = (String) session.getAttribute("isAdmin");
		if (isAdmin == null || isAdmin.isEmpty()) {
			return "redirect:/login.go";
		}
