...
public class AdminMemberController {
	...
	public String teammate(HttpSession session) {
	...
	public Map<String, Object> callList(String currentPage, String state, String searchWord, String searchFlag) {
	...
	public String DetailGo(HttpSession session, Model model, String memberId) {
		String isAdmin = (String) session.getAttribute("isAdmin");
		if (isAdmin == null || isAdmin.isEmpty()) {
			return "redirect:/login.go";
		}
